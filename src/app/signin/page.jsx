    ...
    return (
        <div className='bg-slate-100 dark:bg-[#1E293B] rounded-t-2xl pt-8 pb-8'>
            ...
            <div className='overflow-hidden text-center pt-4 pb-2'>
                <h2 className='text-emerald-600 dark:text-emerald-400 text-3xl md:text-4xl font-bold text-center animate-text-scale'>Welcome Back</h2>
            </div>


            <p className='text-lg md:text-xl font-semibold text-center text-gray-400 pb-6 pt-2'>Sign in to access your account, manage bookings, and continue your study journey.</p>
                ...
                <Card className='border border-gray-100 dark:border-gray-600 shadow-emerald-600 dark:shadow-emerald-800 shadow-lg'>
                    ...
                    <div className='px-4'>
                        ...
                        <Button
                            ...
                            <h1 className='text-lg font-bold'>Sign In With Google</h1>
                        </Button>

                        <h2 className='text-center text-lg pb-6 pt-2'>Do not have an account? <span className='font-bold text-xl text-emerald-600 dark:text-emerald-400'><Link href={"/signup"}>Sign Up</Link></span></h2>
